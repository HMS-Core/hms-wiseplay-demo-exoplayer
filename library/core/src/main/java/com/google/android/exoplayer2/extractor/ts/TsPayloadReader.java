...
public interface TsPayloadReader {
    ...
    interface Factory {
        ...
        TsPayloadReader createPayloadReader(
                int streamType, EsInfo esInfo, DrmInitData drmInitData, byte encryptionMethod);
    }
    ...
    final class EsInfo {
        ...
        public EsInfo(int streamType, String language, List<DvbSubtitleInfo> dvbSubtitleInfos, byte[] descriptorBytes) {
            ...
            this.dvbSubtitleInfos =
                    dvbSubtitleInfos == null ? Collections.emptyList() : Collections.unmodifiableList(dvbSubtitleInfos);
