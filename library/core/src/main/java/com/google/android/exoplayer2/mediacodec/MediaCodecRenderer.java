 ...
 *
 * 2021.8.9-Changed Add exception handling
...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    public static class DecoderInitializationException extends Exception {
        ...
        public DecoderInitializationException(
                Format format, Throwable cause, boolean secureDecoderRequired, MediaCodecInfo mediaCodecInfo) {
            this(
    ...
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({RECONFIGURATION_STATE_NONE, RECONFIGURATION_STATE_WRITE_PENDING, RECONFIGURATION_STATE_QUEUE_PENDING})
    ...
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({DRAIN_ACTION_NONE, DRAIN_ACTION_FLUSH, DRAIN_ACTION_UPDATE_DRM_SESSION, DRAIN_ACTION_REINITIALIZE})
    ...
    private static final byte[] ADAPTATION_WORKAROUND_BUFFER =
            new byte[] {
                0, 0, 1, 103, 66, -64, 11, -38, 37, -112, 0, 0, 1, 104, -50, 15, 19, 32, 0, 0, 1, 101, -120, -124, 13,
                -50, 113, 24, -96, 0, 47, -65, 28, 49, -61, 39, 93, 120
            };
    ...
    public final void setOperatingRate(float operatingRate) throws ExoPlaybackException {
        ...
        if (codec != null && codecDrainAction != DRAIN_ACTION_REINITIALIZE && getState() != STATE_DISABLED) {
    ...
    private void maybeInitCodecWithFallback(MediaCrypto crypto, boolean mediaCryptoRequiresSecureDecoder)
        ...
        while (codec == null) {
            ...
            if (!shouldInitCodec(codecInfo) || hasError()) {
                return;
            }
            try {
                ...
                DecoderInitializationException exception =
                        new DecoderInitializationException(inputFormat, e, mediaCryptoRequiresSecureDecoder, codecInfo);
    ...
    private boolean hasError() {
        ...
        return codecDrmSession.getState() == DrmSession.STATE_ERROR;
    }
    ...
    private List<MediaCodecInfo> getAvailableCodecInfos(boolean mediaCryptoRequiresSecureDecoder)
        ...
        if (codecInfos.isEmpty() && mediaCryptoRequiresSecureDecoder) {
            ...
            codecInfos = getDecoderInfos(mediaCodecSelector, inputFormat, /* requiresSecureDecoder= */ false);
    ...
    private void processOutputFormat() throws ExoPlaybackException {
        ...
        if (codecAdaptationWorkaroundMode != ADAPTATION_WORKAROUND_MODE_NEVER
                ...
                && mediaFormat.getInteger(MediaFormat.KEY_HEIGHT) == ADAPTATION_WORKAROUND_SLICE_WIDTH_HEIGHT) {
    ...
    private static boolean codecNeedsFlushWorkaround(String name) {
        return Util.SDK_INT < 18
                || (Util.SDK_INT == 18 && ("OMX.SEC.avc.dec".equals(name) || "OMX.SEC.avc.dec.secure".equals(name)))
                || (Util.SDK_INT == 19
